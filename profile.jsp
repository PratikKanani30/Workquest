    ...
    <body>
        ...
        <c:forEach var="x" items="${r.rows}">
            ...
            <table border='1'>
                ...
                <tr>
                    <td colspan="2" ><img src="images/${x.photo}" height="100px" width="100px" alt="no photo" /></td>
                </tr>
                <tr>
                    <td>address</td>
