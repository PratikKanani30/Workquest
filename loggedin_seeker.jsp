    ...
    <body>
        ...
        <div style="height: 200px">
            <section class="color-8">
				<p class="perspective">
                                    <a href="project_bid.jsp"><button class="btn btn-8 btn-8a btn-color">See Project And Bid</button></a>
				</p>
				<p class="perspective">
                                    <a href="see_profile.jsp"><button class="btn btn-8 btn-8b btn-color">See Profile</button></a>
				</p>
				<br />
				<p class="perspective">
                                    <a href="add_task.jsp"><button class="btn btn-8 btn-8c btn-color">See And Add Task</button></a>
				</p>
				<p class="perspective">
                                    <a href="assigned_task.jsp"><button class="btn btn-8 btn-8d btn-color">See Assigned Task</button></a>
				</p>
				
				<p class="perspective">
                                    <a href="submit_project.jsp"><button class="btn btn-8 btn-8e btn-color">Submit ur Work</button></a>
				</p>
				<p class="perspective">
        ...
        <sql:query dataSource="${ds}" var="r1">
            select * from alert_user where uid=${uid}
        </sql:query>
